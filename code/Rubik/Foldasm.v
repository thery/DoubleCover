(* =========================================================================  *)
(*  Foldasm.v -- the fold assembled, still with no data.                      *)
(*                                                                            *)
(*  Foldinst.v turns each check into the fact Fold.v asks for, Foldbr.v turns *)
(*  Fold.v's conclusion into Farp1's rank certificate.  This file puts the    *)
(*  two together and gets p1checkStepr.                                       *)
(*                                                                            *)
...
(* every orbit index is below norbi -- Foldtab.frepL, as a hypothesis so
...
(* the stabiliser fact, which Foldchk.stabE_of_check supplies from stabC *)
