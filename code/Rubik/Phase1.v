...
(*                                                                            *)
(*  Four of those bits are the distance, capped where the generator stopped   *)
(*  walking, never an offset clamped from below: that would overstate the     *)
(*  distance for a state that is nearer, and could prune away a real          *)
(*  solution.  Capping from above is the safe direction.  Nothing below reads *)
(*  the cap: the two checks are what make the heuristic admissible, whatever  *)
(*  the table holds.                                                          *)
(* =========================================================================  *)
