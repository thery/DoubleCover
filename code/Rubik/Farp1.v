(* =========================================================================  *)
(*  Farp1.v -- The three axis views, and the phase 1 search built on them.    *)
(* =========================================================================  *)
...
Require Import Ball Table Tabi Rubik333 Sym Coordfs Coordfsi Fstab FsTable
        Moves Searchr Redun Searchir P1Fs P1Fsm Phase1 Far Fsparity.
