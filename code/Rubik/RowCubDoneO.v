(* =========================================================================  *)
(*  RowCubDoneO.v -- the plain theorem, the run over the constants.           *)
(* =========================================================================  *)
...
Require Import RowCubDefO RowCubBoolO RowCubProofO.
...
Print Assumptions real_superflip_row_cub_runO.
