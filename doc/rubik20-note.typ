...
search, and so are a turn and its inverse. We take the top face, so our two
first moves are $U$ and $U^2$; any other face would have done. A position with
no symmetry has nothing to gain here.
