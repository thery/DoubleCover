...
and left and right swapped, and #src("HProp2.v") checks this for each of the twelve quarter turns. So
$P^(-1) x P$ is the six turns `U U D D R B`, and $w$ followed by them,
