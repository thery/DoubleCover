(* =========================================================================  *)
(*  RowCubL10.v -- the row stopped at 10 levels.                             *)
(* =========================================================================  *)
...
(* the same map, 10 levels instead of twenty *)
Definition ycprobe : rmap :=
  ymfin e8numi e4biti mpgi mgri mswi mloi mhii p1 actfsri tomemb okmvv srch 10.
