(* =========================================================================  *)
(*  RowBenchCountN.v -- the plain run with every optimisation, timed to 13    *)
(*  beside the section run it is proved equal to.                             *)
(* =========================================================================  *)

(* A BENCH, not part of any proof.  rowmappiO against rowmappiD, both in      *)
(* RowCubDef, alternated, twice each: the counts must be 14 731 320           *)
(* all four.                                                                  *)
...
Require Import RowRunConst RowCubDef.
