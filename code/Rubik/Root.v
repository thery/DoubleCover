...
(*  Root.v                                                                    *)
(*                                                                            *)
(*  The first move of a maneuver, up to symmetry.                             *)
(*                                                                            *)
(*  A position fixed by all 48 symmetries -- the superflip is one -- can be   *)
(*  assumed to be solved by a maneuver starting with U or U2.  Indeed if      *)
(*  g * m is within d and m ^ u is a root move, then                          *)
(*                                                                            *)
(*      g * m ^ u  =  g ^ u * m ^ u  =  (g * m) ^ u                           *)
(*                                                                            *)
(*  which is within d as well, the symmetries stabilising the move set.       *)
(*                                                                            *)
(*  WHY IT MATTERS.  The search that gives the lower bound branches 18 ways   *)
(*  at the root and about 13.35 ways afterwards; restricting the first move   *)
(*  to two of the eighteen divides the whole tree by nine.  For the depth 19  *)
(*  search on the superflip that is the difference between a computation of   *)
(*  a few hours and one of more than a day.                                   *)
(*                                                                            *)
(*  The mirror Sm is what makes it two rather than three: without it U^-1     *)
(*  would be a third orbit, since the rotations alone cannot reverse a turn.  *)
(* =========================================================================  *)

From mathcomp Require Import all_ssreflect all_fingroup.
Require Import Cyc Ball Table Rubik333 Sym Search.
