(* =========================================================================  *)
(*  RowPartU.v -- the outer eight are a permutation.                          *)
(* =========================================================================  *)

(* At each of the 40320 outer ranks: a permutation of the forty eight         *)
(* facelets that leaves everything outside the outer eight alone and keeps    *)
(* them.                                                                      *)
(*                                                                            *)
