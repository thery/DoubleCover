(* =========================================================================  *)
(*  Foldbr.v -- the orbit check in place of the rank sweep.                    *)
(*                                                                            *)
(*  Fold.Dfoldi_step_of_check says the folded read drops by at most one        *)
(*  across a move, at every rank, having checked it only at the 64 430 orbit  *)
(*  representatives.  Farp1.p1checkStepr is the same statement as a BOOLEAN   *)
(*  over all 1 013 760 ranks.  This file builds that boolean from the fact,   *)
(*  which is what lets the orbit check stand in for the rank sweep -- and     *)
(*  nothing downstream of p1checkStepr changes.                               *)
(*                                                                            *)
(*  The table is a variable, so the file compiles without it.                 *)
(* =========================================================================  *)
