...
(*  stopping the search at p1cap does.  At this cap nothing is capped: no     *)
(*  phase 1 distance is larger, so an entry is the exact distance.            *)
(* =========================================================================  *)

Definition p1cap     := 12.       (* mkfold.sh emits with `p1gen 12 emitfold' *)
