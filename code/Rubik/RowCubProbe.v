(* =========================================================================  *)
(*  RowCubProbe.v -- the same run, stopped short, to watch the memory.        *)
(* =========================================================================  *)
...
(* the same map, fourteen levels instead of twenty *)
Definition ycprobe : rmap :=
  ymfin e8numi e4biti mpgi mgri mswi mloi mhii p1 actfsri tomemb okmvv srch 14.
