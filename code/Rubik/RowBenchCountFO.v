(* =========================================================================  *)
(*  RowBenchCountFO.v -- the folded run with every optimisation, timed to 13  *)
(*  beside the D run it is proved equal to.                                   *)
(* =========================================================================  *)

(* A BENCH, not part of any proof.  rowmapiO (RowFoldCubDefO) against        *)
(* rowmapiD (RowFoldCubDefD), alternated, twice each: the counts must be     *)
(* 14 731 320 all four.                                                       *)
...
Require Import RowFoldCubDefD RowFoldCubDefO.
