...
The rest of the note is two extensions of that proof, this one and the next,
both on the same trunk. The first changes the count of moves. In quarter turns there are
