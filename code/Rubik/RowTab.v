...
(* RowTabL.v and RowTabP.v are the numbers, written by ocaml/rubik_row.ml.    *)
(* This file makes them arrays and CHECKS them: Row.e8ok and Row.e4ok say the *)
(* layout is a bijection, and RowInst's srcok and halfok say the bit tables    *)
(* and btmv agree.  Nothing about how they were built is trusted.             *)
(*                                                                            *)
