...
have h1e: 1 = (IZR (Z.pow radix2 (p - 1)) * bpow radix2 (1 - p)).
...
have h1e: 1 = (IZR (Z.pow radix2 p ) * bpow radix2 ( - p)).
...
rewrite -Zeven.Zodd_even_bool {1}Z.sub_1_r Z.odd_pred Z.even_pow /=; try lia.
